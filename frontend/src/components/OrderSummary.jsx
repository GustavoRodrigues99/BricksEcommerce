...
const stripePromise = loadStripe("pk_test_51R1sSAPL4Sq7oF0HFoW11NQ6d9dXuPTrN2uh5rULOAVb7244CUm3R2YGj7h2kXm6ihjAMRLnDaYxMlj7v7AQmdid00v87b0q2o");
...
const OrderSummary = () => {
  ...
  return (
    ...
    >
        <p className='text-xl font-semibold text-purple-400'>Pedido</p>
        ...
        <div className='space-y-4'>
            <div className='space-y-2'>
                ...
                {savings > 0 && (
                    <dl className='flex items-center justify-between gap-4'>
                        <dt className='text-base font-normal text-gray-300'>Economia</dt>
                        <dd className='text-base font-medium text-purple-400'>-R$ {formattedSavings}</dd>
                    </dl>
                )}

                {coupon && isCouponApplied && (
                    <dl className='flex items-center justify-between gap-4'>
                        <dt className='text-base font-normal text-gray-300'>Cupom</dt>
                ...
                <dl className='flex items-center justify-between gap-4 border-t border-gray-600 pt-2'>
                    ...
                    <dd className='text-base font-medium text-purple-400'>R$ {formattedTotal}</dd>
                </dl>
            </div>
