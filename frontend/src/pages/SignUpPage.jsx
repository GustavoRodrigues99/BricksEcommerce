...
import { UserPlus, Mail, Lock, User, ArrowRight, LoaderCircle } from "lucide-react";
...
const SignUpPage = () => {
  ...
  return (
    <div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
        ...
        >
            <h2 className='mt-6 text-center text-3xl font-extrabold text-purple-400'>Crie sua Conta</h2>
        </motion.div>
                    ...
                    <div>
                        ...
                        <div className='mt-1 relative rounded-md shadow-sm'>
                            ...
                            <input
                                ...
                                placeholder='Gustavo Rodrigues Gonçalves'
                            />
                        </div>
                    </div>
