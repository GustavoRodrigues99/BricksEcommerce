			...
			>
				<div className='p-6 sm:p-8'>
					...
					<p className='text-gray-300 text-center mb-6'>
						Sua compra foi cancelada. Nenhuma cobrança sera efetuada
					</p>
					<div className='bg-gray-700 rounded-lg p-4 mb-6'>
						<p className='text-sm text-gray-400 text-center'>
							Caso tenha encontrado algum erro durante o processo de compra, favor entrar em contato com nosso suporte
						</p>
					</div>
